...
public class ModelTests {
	...
	public void crash_test(){
		Model m1 = new Model(600, 300, 35);
		Trash t1 = new Trash(m1.getFrameWidth());
	...
	public void update_test(){
		Model m1 = new Model(500, 200, 70);
		Model m2 = new Model(500, 200, 70);
		m1.getPlayer().setDir(Direction.WEST);
		m2.getPlayer().setDir(Direction.WEST);
		m1.update(m1.getPlayer());
		m1.update(m2.getPlayer());
		assertTrue(m1.getPlayer() == m2.getPlayer());
